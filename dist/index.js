...
function Square(props) {
    ...
    return _react2.default.createElement(
        'button',
        { className: 'square', style: style, onClick: function onClick() {
...
var Board = function (_React$Component) {
    ...
    _createClass(Board, [{
        ...
        value: function renderSquare(i, j) {
            ...
            var index = i * this.props.col + j;
            var line = this.props.line;
            var highLight = line && line.indexOf(index) !== -1;
...
var Game = function (_React$Component2) {
    ...
    function Game() {
        ...
        var _this3 = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).apply(this, arguments));

        var total = _this3.props.row * _this3.props.col;
    ...
    _createClass(Game, [{
        key: 'calculateWinner',
        value: function calculateWinner(squares, currMove) {
            var currSquare = squares[currMove];
            if (!currSquare) {
                return {
                    winner: null,
                    line: null
            ...
            var total = this.props.row * this.props.col;
            var directions = [1, this.props.col, this.props.col + 1, this.props.col - 1];
        ...
        value: function handleClick(i) {
            ...
            var _calculateWinner = this.calculateWinner(squares, i),
        ...
        value: function jumpTo(step) {
            var current = this.state.history[step];

            var _calculateWinner2 = this.calculateWinner(current.squares, current.move),
                winner = _calculateWinner2.winner,
                line = _calculateWinner2.line;
        ...
        value: function render() {
            ...
            var moves = history.map(function (step, moveIndex) {
                var row = Math.floor(step.move / _this4.props.col) + 1;
                var col = step.move % _this4.props.col + 1;
                var desc = moveIndex ? 'Move #(' + row + ', ' + col + ')' : 'Game start';

                var style = {};
                if (moveIndex === _this4.state.stepNumber) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: '#', style: style, onClick: function onClick() {
...
_reactDom2.default.render(_react2.default.createElement(Game, { row: 15, col: 15 }), document.getElementById('root'));
